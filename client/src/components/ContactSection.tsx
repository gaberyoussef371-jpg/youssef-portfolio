 ...
 * Design: Liquid Obsidian — strong dark section with gold accents
 */
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full px-6 py-4 bg-[#C9A96E] text-black font-semibold text-sm rounded-xl hover:bg-[#D4B87A] hover:shadow-[0_0_40px_rgba(201,169,110,0.2)] transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-2"
              >
